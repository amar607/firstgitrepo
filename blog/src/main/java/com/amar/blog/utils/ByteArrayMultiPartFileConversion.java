...
public class ByteArrayMultiPartFileConversion implements MultipartFile {
    ...
    public ByteArrayMultiPartFileConversion(byte[] fileContent, String fileName, String contentType) {
